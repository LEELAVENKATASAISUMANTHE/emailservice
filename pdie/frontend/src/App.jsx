...
import { StorageMetrics, LiveStream } from './components/DashboardWidgets.jsx';
      ...
      <main className="main-content">
        ...
        <div className="dashboard">
          <section className="hero">
            <h1>Ingestion Canvas</h1>
            <p>
              Configure technical data mapping and workbook validation protocols with 0px precision. 
              Select tables, define schemas, and monitor pipeline health from a single monochrome interface.
            </p>
          </section>
